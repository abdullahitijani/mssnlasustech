...
if ( ! class_exists( 'Classic_Portfolio_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Classic_Portfolio_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$classic_portfolio_contents = wp_remote_retrieve_body( $response );

			return $classic_portfolio_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Classic_Portfolio_WPTT_WebFont_Loader( $url );
